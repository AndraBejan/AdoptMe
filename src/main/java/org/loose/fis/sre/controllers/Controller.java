...
public class Controller {
    ...
    public void redirectToMyProfile() throws IOException {
        ...
        OwnerController uc = loader.getController();
        uc.setUser(user);
    }
    ...
    public void handleViewAnnouncementAction(Announcement announcement, Event event) throws Exception{
        try {
            ...
            OwnerController rc = loader.getController();
            rc.setUser(user);
            rc.setAnnouncement(announcement);
        }
        catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void setUser(User user) throws MalformedURLException {
        ...
        if(AccountStatus != null){
            AccountStatus.setText("Logged-in as " + user.getName());
        }
